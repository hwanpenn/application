    ...
    $(document).ready(function () {
        ...
        $menu.find('li.layui-nav-item').each(function () {
            ...
            $that.on('click', function () {
				...
				var pid_0 = [{"pid":"100","title":"后台首页","icon":"larry-houtaishouye","href":"html/main.html"},
                    {"pid":"101","title":"流程中心","icon":"larry-gerenxinxi5","spread":"true","children":[{"title":"住房公积金业务","icon":"larry-gerenxinxi1","href":"html/myloginfo.html"}]},
                        {"pid":"102","title":"流程规则管理","icon":"larry-houtaishouye","href":"html/myloginfo.html"},
                            {"pid":"103","title":"流程颜色设置","icon":"larry-houtaishouye","href":"html/myloginfo.html"}];
